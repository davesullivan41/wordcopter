...
//..__<<numof()=0>><<COMMENTING=0>>	friend class ChoiceIterator;
public:
...
//..__<<numof()=1>><<COMMENTING=0>>	class ChoiceIterator {//................<class ChoiceIterator {>//..__<<numof()=1>><<COMMENTING=0>>	class ChoiceIterator {
//..__<<numof()=1>><<COMMENTING=10000>>	public:
...
//..__<<numof()=1>><<COMMENTING=10001>>	explicit ChoiceIterator(const LTRResultIterator& result_it);
//..__<<numof()=1>><<COMMENTING=0>>	~ChoiceIterator();
//..__<<numof()=1>><<COMMENTING=0>>	
// Moves to the next choice for the symbol and returns false if there
// are none left.
//..__<<numof()=1>><<COMMENTING=0>>	bool Next();
//..__<<numof()=1>><<COMMENTING=1>>	
// ============= Accessing data ==============.
//..__<<numof()=1>><<COMMENTING=1>>	
// Returns the null terminated UTF-8 encoded text string for the current
// choice.
...
//..__<<numof()=1>><<COMMENTING=1>>	const char* GetUTF8Text() const;
//..__<<numof()=1>><<COMMENTING=2>>	
// Returns the confidence of the current choice.
// The number should be interpreted as a percent probability. (0.0f-100.0f)
//..__<<numof()=1>><<COMMENTING=2>>	float Confidence() const;
//..__<<numof()=1>><<COMMENTING=3>>	
//..__<<numof()=1>><<COMMENTING=3>>	private:
// Pointer to the WERD_RES object owned by the API.
//..__<<numof()=1>><<COMMENTING=4>>	WERD_RES* word_res_;
// Iterator over the blob choices.
//..__<<numof()=1>><<COMMENTING=5>>	BLOB_CHOICE_IT* choice_it_;
//..__<<numof()=0>><<COMMENTING=106>>	};	//..<<numof()=0>><<COMMENTING=106>>	
