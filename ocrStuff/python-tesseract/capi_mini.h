...
//..__<<numof()=0>><<COMMENTING=0>>	typedef tesseract::DictFunc TessDictFunc;
//..__<<numof()=0>><<COMMENTING=0>>	typedef tesseract::ProbabilityInContextFunc TessProbabilityInContextFunc;
...
#ifdef TESS_CAPI_INCLUDE_BASEAPI
//..__<<numof()=0>><<COMMENTING=0>>	TESS_API int   TESS_CALL TessBaseAPIInit(TessBaseAPI* handle, const char* datapath, const char* language,//................<TESS_API int   TESS_CALL TessBaseAPIInit(TessBaseAPI* handle, const char* datapath, const char* language,>//..__<<numof()=0>><<COMMENTING=0>>	TESS_API int   TESS_CALL TessBaseAPIInit(TessBaseAPI* handle, const char* datapath, const char* language,
//..__<<numof()=0>><<COMMENTING=10000>>	TessOcrEngineMode mode, char** configs, int configs_size,
//..__<<numof()=0>><<COMMENTING=10001>>	const STRING* vars_vec, size_t vars_vec_size,
//..__<<numof()=0>><<COMMENTING=10002>>	const STRING* vars_values, size_t vars_values_size, BOOL set_only_init_params);
#endif
//..__<<numof()=0>><<COMMENTING=0>>	TESS_API int   TESS_CALL TessBaseAPIInit1(TessBaseAPI* handle, const char* datapath, const char* language, TessOcrEngineMode oem,//................<TESS_API int   TESS_CALL TessBaseAPIInit1(TessBaseAPI* handle, const char* datapath, const char* language, TessOcrEngineMode oem,>//..__<<numof()=0>><<COMMENTING=0>>	TESS_API int   TESS_CALL TessBaseAPIInit1(TessBaseAPI* handle, const char* datapath, const char* language, TessOcrEngineMode oem,
//..__<<numof()=0>><<COMMENTING=10000>>	char** configs, int configs_size);
//..__<<numof()=0>><<COMMENTING=0>>	TESS_API int   TESS_CALL TessBaseAPIInit2(TessBaseAPI* handle, const char* datapath, const char* language, TessOcrEngineMode oem);
//..__<<numof()=0>><<COMMENTING=0>>	TESS_API int   TESS_CALL TessBaseAPIInit3(TessBaseAPI* handle, const char* datapath, const char* language);

//..__<<numof()=0>><<COMMENTING=0>>	TESS_API int TESS_CALL TessBaseAPIInit4(TessBaseAPI* handle, const char* datapath, const char* language, TessOcrEngineMode mode,//................<TESS_API int TESS_CALL TessBaseAPIInit4(TessBaseAPI* handle, const char* datapath, const char* language, TessOcrEngineMode mode,>//..__<<numof()=0>><<COMMENTING=0>>	TESS_API int TESS_CALL TessBaseAPIInit4(TessBaseAPI* handle, const char* datapath, const char* language, TessOcrEngineMode mode,
//..__<<numof()=0>><<COMMENTING=10000>>	char** configs, int configs_size,
//..__<<numof()=0>><<COMMENTING=10001>>	char** vars_vec, char** vars_values, size_t vars_vec_size,
//..__<<numof()=0>><<COMMENTING=10002>>	BOOL set_only_non_debug_params);
...
//..__<<numof()=0>><<COMMENTING=0>>	TESS_API int   TESS_CALL TessBaseAPIInitLangMod(TessBaseAPI* handle, const char* datapath, const char* language);
//..__<<numof()=0>><<COMMENTING=0>>	TESS_API void  TESS_CALL TessBaseAPIInitForAnalysePage(TessBaseAPI* handle);
...
#ifdef TESS_CAPI_INCLUDE_BASEAPI
//..__<<numof()=0>><<COMMENTING=0>>	TESS_API void  TESS_CALL TessBaseAPISetDictFunc(TessBaseAPI* handle, TessDictFunc f);
TESS_API void  TESS_CALL TessBaseAPIClearPersistentCache(TessBaseAPI* handle);
//..__<<numof()=0>><<COMMENTING=0>>	TESS_API void  TESS_CALL TessBaseAPISetProbabilityInContextFunc(TessBaseAPI* handle, TessProbabilityInContextFunc f);

//..__<<numof()=0>><<COMMENTING=0>>	TESS_API void  TESS_CALL TessBaseAPISetFillLatticeFunc(TessBaseAPI* handle, TessFillLatticeFunc f);
...
//..__<<numof()=0>><<COMMENTING=0>>	TESS_API void  TESS_CALL TessBaseAPIInitTruthCallback(TessBaseAPI* handle, TessTruthCallback* cb);
